...
public class MainServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // /*
        String line = choose(new File("C:\\Users\\maxan\\IdeaProjects\\sqli-injection\\sqli\\Queries.txt"));
        resp.setContentType("text/html");
        PrintWriter printWriter = resp.getWriter();
        if (username == null) {
            printWriter.write("Hello, unknown user!" + "<br>");
            printWriter.write("Check this query: " + line.replace(" ", "+") + "<br>");
            ...
            if (sqlHandler(sqlString)) {
                ...
                if (Character.getNumericValue(label) == prediction) {
                    ...
                    try {
                        URI uri = new URI("https://www.spbstu.ru");
                        desktop.browse(uri);
                    ...
                    // false alarm
                    falsePos++;
                    printWriter.write("The query has verified, " + "<br>" + line + "<br>");
                }
            } else {
                prediction = 0;
                if (Character.getNumericValue(label) == prediction) {
